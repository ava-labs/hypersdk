...
var (
	_ chain.VM              = (*VM[Controller])(nil)
	_ gossiper.VM           = (*VM[Controller])(nil)
	_ builder.VM            = (*VM[Controller])(nil)
	_ block.ChainVM         = (*VM[Controller])(nil)
	_ block.StateSyncableVM = (*VM[Controller])(nil)
)
