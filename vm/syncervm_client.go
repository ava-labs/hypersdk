...
type stateSyncerClient[T Controller] struct {
	vm          *VM[T]
...
func (s *stateSyncerClient[_]) AcceptedSyncableBlock(
	_ context.Context,
...
func (s *stateSyncerClient[_]) UpdateSyncTarget(b *chain.StatelessBlock) (bool, error) {
