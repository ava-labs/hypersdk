...
import (
	...
	lconsts "github.com/ava-labs/hypersdk/x/programs/examples/wrvm/consts"
	"github.com/ava-labs/hypersdk/x/programs/examples/wrvm/controller"
	"github.com/ava-labs/hypersdk/x/programs/examples/wrvm/genesis"
	lrpc "github.com/ava-labs/hypersdk/x/programs/examples/wrvm/rpc"
	"github.com/ava-labs/hypersdk/x/programs/examples/wrvm/utils"
)
...
func TestIntegration(t *testing.T) {
	...
	ginkgo.RunSpecs(t, "wrvm integration test suites")
}
