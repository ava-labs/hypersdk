...
func NewConfigBuilder() *ConfigBuilder {
	return &ConfigBuilder{
		EnableBulkMemory:         engine.DefaultEnableBulkMemory,
		EnableWasmMultiValue:     engine.DefaultMultiValue,
		EnableWasmReferenceTypes: engine.DefaultEnableReferenceTypes,
		EnableWasmSIMD:           engine.DefaultSIMD,
		MaxWasmStack:             engine.DefaultMaxWasmStack,
		LimitMaxMemory:           engine.DefaultLimitMaxMemory,
		ProfilingStrategy:        engine.DefaultProfilingStrategy,
...
func (c *ConfigBuilder) WithCompileStrategy(strategy engine.CompileStrategy) *ConfigBuilder {
...
func (c *ConfigBuilder) Build() (*Config, error) {
	...
	return &Config{
		store: engine.NewStoreConfig(c.LimitMaxMemory),
...
func (c *Config) StoreCfg() *engine.StoreConfig {
	return c.store
}

// Engine returns a new wasmtime engine config. A wasmtime config can only be used once.
func (c *Config) EngineCfg() (*engine.Config, error) {
