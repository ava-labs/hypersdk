...
pub mod bindings {
    ...
    pub fn inc(context: wasmlanche_sdk::ExternalCallContext, to: Address, amount: Count) -> bool {
        context
            .program()
            .call_function::<_, _>("inc", (to, amount), 1_000_000)
            .unwrap()
    }

    pub fn get_value(context: wasmlanche_sdk::ExternalCallContext, to: Address) -> u64 {
        context
            .program()
            .call_function::<_, _>("get_value", to, 1_000_000)
            .unwrap()
    }
}
...
// #[cfg(not(feature = "bindings"))]
fn get_value_internal(context: &wasmlanche_sdk::Context<StateKeys>, of: Address) -> Count {
    context
        .program
        .state()
