...
mod tests {
    ...
    fn wrong_assertion() {
        ...
        plan.add_step(Step {
            ...
            method: "inc".into(),
            max_units: 1000000,
            params: vec![counter1_id.into(), bob_key.clone(), 10.into()],
            require: None,
        });
        ...
        plan.add_step(Step {
            ...
            params: vec![counter1_id.into(), bob_key.clone()],
            require: Some(Require {
                result: ResultAssertion::NumericEq(11),
            }),
        });
        ...
        assert!(success_responses.all(|resp| resp.error.is_none()));
        let last_response = responses.next().unwrap().error;
