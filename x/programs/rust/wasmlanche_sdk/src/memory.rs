...
pub fn to_host_ptr(arg: &[u8]) -> Result<RuntimePtr, StateError> {
...
pub fn split_host_ptr(arg: RuntimePtr) -> (i64, usize) {
    assert!(arg >= 0);
...
pub unsafe fn from_host_ptr<V>(ptr: RuntimePtr) -> Result<V, StateError>
where
    V: BorshDeserialize,
{
...
#[must_use]
pub fn into_bytes(host_ptr: RuntimePtr) -> Vec<u8> {
