...
type TxBlock struct {
	// Prnt may either be a previous TxBlock or a RootBlock (if the first TxBlock
	// after a RootBlock). This is done because state may be modified in
	// RootBlock and this Prnt field should indicate where we should get the view
	// to build from.
