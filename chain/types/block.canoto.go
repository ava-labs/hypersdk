...
func (*Block[T1]) MakeCanoto() *Block[T1] {
	return new(Block[T1])
}
...
func (c *Block[T1]) UnmarshalCanoto(bytes []byte) error {
	r := canoto.Reader{
		B: bytes,
	}
...
func (c *Block[T1]) UnmarshalCanotoFrom(r canoto.Reader) error {
	var minField uint32
...
func (c *Block[T1]) ValidCanoto() bool {
	if c == nil {
		return true
	}
...
func (c *Block[T1]) CalculateCanotoCache() {
	if c == nil {
		return
	}
	c.canotoData.size = 0
...
func (c *Block[T1]) CachedCanotoSize() int {
	if c == nil {
		return 0
	}
...
//
// It is not safe to call this function concurrently.
func (c *Block[T1]) MarshalCanoto() []byte {
...
//
// It is not safe to call this function concurrently.
func (c *Block[T1]) MarshalCanotoInto(w canoto.Writer) canoto.Writer {
	if c == nil {
		return w
	}
	if !canoto.IsZero(c.ParentID) {
