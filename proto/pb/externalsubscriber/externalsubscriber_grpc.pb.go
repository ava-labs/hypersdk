...
const (
	ExternalSubscriber_ProcessBlock_FullMethodName = "/externalsubscriber.ExternalSubscriber/ProcessBlock"
...
func (c *externalSubscriberClient) ProcessBlock(ctx context.Context, in *BlockRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ExternalSubscriber_ProcessBlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExternalSubscriber_ProcessBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExternalSubscriber_ProcessBlock_FullMethodName,
	}
