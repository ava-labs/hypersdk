...
func (x *ChunkSignature) GetExpiry() int64 {
	if x != nil {
		return x.Expiry
	}
	return 0
...
type GetChunkSignatureResponse struct {
	...
	Signature *ChunkSignature `protobuf:"bytes,1,opt,name=signature,proto3" json:"signature,omitempty"`
}
...
func (x *GetChunkSignatureResponse) GetSignature() *ChunkSignature {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_dsmr_dsmr_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x72, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x0e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x53, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68, 0x75, 0x6e, 0x6b,
	...
	0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x23, 0x0a, 0x0b,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x62,
	0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x62, 0x79, 0x74, 0x65,
	0x73, 0x22, 0x99, 0x01, 0x0a, 0x10, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x43, 0x65, 0x72, 0x74, 0x69,
	...
	0x6e, 0x6b, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x68, 0x75, 0x6e, 0x6b,
	...
	,
}
...
var file_dsmr_dsmr_proto_goTypes = []interface{}{
	...
	(*ChunkSignature)(nil),            // 1: dsmr.ChunkSignature
	(*Transaction)(nil),               // 2: dsmr.Transaction
	...
	(*GetChunkResponse)(nil),          // 6: dsmr.GetChunkResponse
	(*GetChunkSignatureRequest)(nil),  // 7: dsmr.GetChunkSignatureRequest
	(*GetChunkSignatureResponse)(nil), // 8: dsmr.GetChunkSignatureResponse
}
var file_dsmr_dsmr_proto_depIdxs = []int32{
	2, // 0: dsmr.Chunk.transactions:type_name -> dsmr.Transaction
	2, // 1: dsmr.ExecutedChunk.transactions:type_name -> dsmr.Transaction
	0, // 2: dsmr.GetChunkResponse.chunk:type_name -> dsmr.Chunk
	0, // 3: dsmr.GetChunkSignatureRequest.chunk:type_name -> dsmr.Chunk
	1, // 4: dsmr.GetChunkSignatureResponse.signature:type_name -> dsmr.ChunkSignature
