...
func TestScope(t *testing.T) {
	...
	// No Scope
	tsv := ts.NewView(state.Keys{}, ImmutableScopeStorage(map[string][]byte{}))
...
func TestGetValue(t *testing.T) {
	...
	// Set Scope
	tsv := ts.NewView(state.Keys{string(testKey): state.Read | state.Write}, ImmutableScopeStorage(map[string][]byte{string(testKey): testVal}))
	val, err := tsv.GetValue(ctx, testKey)
...
func TestGetValueNoStorage(t *testing.T) {
	...
	tsv := ts.NewView(state.Keys{string(testKey): state.Read | state.Write}, ImmutableScopeStorage(map[string][]byte{}))
...
func TestInsertNew(t *testing.T) {
	...
	// SetScope
	tsv := ts.NewView(state.Keys{string(testKey): state.All}, ImmutableScopeStorage(map[string][]byte{}))
...
func TestInsertInvalid(t *testing.T) {
	...
	tsv := ts.NewView(state.Keys{string(key): state.Read | state.Write}, ImmutableScopeStorage(map[string][]byte{}))
...
func TestInsertRemoveInsert(t *testing.T) {
	...
	// SetScope and add
	tsv := ts.NewView(state.Keys{key2str: state.All}, ImmutableScopeStorage(map[string][]byte{}))
	require.Equal(0, ts.OpIndex())
...
func TestModifyRemoveInsert(t *testing.T) {
	...
	// SetScope and add
	tsv := ts.NewView(state.Keys{key2str: state.All}, ImmutableScopeStorage(map[string][]byte{key2str: testVal}))
	require.Equal(0, ts.OpIndex())
...
func TestModifyRevert(t *testing.T) {
	...
	// SetScope and add
	tsv := ts.NewView(state.Keys{key2str: state.Read | state.Write}, ImmutableScopeStorage(map[string][]byte{key2str: testVal}))
	require.Equal(0, ts.OpIndex())
...
func TestRestoreInsert(t *testing.T) {
	...
	// Store keys
	tsv := ts.NewView(keySet, ImmutableScopeStorage(map[string][]byte{}))
...
func TestCreateView(t *testing.T) {
	...
	tsvM := ts.NewView(keySet, ImmutableScopeStorage(map[string][]byte{}))
...
func TestGetValuePermissions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.TODO()
			ts := New(10)
			tsv := ts.NewView(state.Keys{tt.key: tt.permission}, ImmutableScopeStorage(map[string][]byte{tt.key: testVal}))
...
func TestUpdatingKeyPermission(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tsv := ts.NewView(keys, ImmutableScopeStorage(map[string][]byte{tt.key: testVal}))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.keyExists {
				...
				tsv = ts.NewView(keys, ImmutableScopeStorage(map[string][]byte{}))
			}
