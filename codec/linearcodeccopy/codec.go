...
import (
	...
	"github.com/ava-labs/hypersdk/codec/codeccopy"
	"github.com/ava-labs/hypersdk/codec/reflectcodeccopy"
)

var (
	_ Codec              = (*linearCodec)(nil)
	_ codeccopy.Codec    = (*linearCodec)(nil)
...
func New(tagNames []string) Codec {
	...
	hCodec.Codec = reflectcodeccopy.New(hCodec, tagNames)
	return hCodec
}
...
func NewDefault() Codec {
	return New([]string{reflectcodeccopy.DefaultTagName})
}
