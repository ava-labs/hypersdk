...
that can be read/stored to satisfy this requirement.  The size suffix is part of the key,
so the same base key with two different sizes are considered two different keys.
