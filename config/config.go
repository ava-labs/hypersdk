...
func (c *Config) GetChunkBuildFrequency() time.Duration           { return 200 * time.Millisecond }
func (c *Config) GetBlockBuildFrequency() time.Duration           { return 750 * time.Millisecond }
