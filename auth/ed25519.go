...
var _ chain.Auth[*ED25519] = (*ED25519)(nil)
...
func (*ED25519) ComputeUnits() uint64 {
...
var _ chain.AuthFactory[*ED25519] = (*ED25519Factory)(nil)

func NewED25519Factory(priv ed25519.PrivateKey) *ED25519Factory {
	return &ED25519Factory{priv: priv}
}

type ED25519Factory struct {
	priv ed25519.PrivateKey `canoto:"fixed bytes,1"`

	canotoData canotoData_ED25519Factory
}

func (d *ED25519Factory) Sign(msg []byte) (*ED25519, error) {
