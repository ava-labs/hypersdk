...
# Ensure the aizelvm root as the working directory
...
echo "building aizelvm"

# rebuild with latest code
go build -o "${AVALANCHEGO_PLUGIN_DIR}"/qCNyZHrs3rZX458wPJXPJJypPf6w423A84jnfbdP2TPEmEE9u ./cmd/aizelvm
