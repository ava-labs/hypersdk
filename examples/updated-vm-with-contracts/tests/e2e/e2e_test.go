...
const owner = "updated-vm-with-contracts-e2e-tests"

var flagVars *e2e.FlagVars

func TestE2e(t *testing.T) {
	ginkgo.RunSpecs(t, "updated vm with contract e2e test suites")
}
...
// Construct tmpnet network with a single contracts VM
