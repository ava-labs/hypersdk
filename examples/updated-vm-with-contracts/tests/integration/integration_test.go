...
import (
	...
	lconsts "github.com/ava-labs/hypersdk/examples/updated-vm-with-contracts/consts"
	morpheusWorkload "github.com/ava-labs/hypersdk/examples/updated-vm-with-contracts/tests/workload"
