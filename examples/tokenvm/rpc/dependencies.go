...
type Controller interface {
	...
	GetAssetFromState(context.Context, ids.ID) (bool, []byte, uint8, []byte, uint64, codec.AddressBytes, bool, error)
	GetBalanceFromState(context.Context, codec.AddressBytes, ids.ID) (uint64, error)
