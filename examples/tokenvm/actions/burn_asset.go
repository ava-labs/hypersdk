...
func (b *BurnAsset) StateKeys(actor codec.Address, _ ids.ID) []types.Key {
	return []types.Key{
		{Name: string(storage.AssetKey(b.Asset)), Mode: types.RWrite},
		{Name: string(storage.BalanceKey(actor, b.Asset)), Mode: types.RWrite},
	}
}
