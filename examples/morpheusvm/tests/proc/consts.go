...
const (
	...
	defaultInitialBalance uint64 = 10_000_000_000_000
	// minimum block gap
	minBlockGap = 100 // 100ms
)

var (
	// hardcoded initial set of ed25519 keys. Each will be initialized with defaultInitialBalance
