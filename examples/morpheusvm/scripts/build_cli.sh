...
HYPERSDK_DIR=${GOPATH}/src/github.com/ava-labs/hypersdk
MORPHEUSVM_DIR=${HYPERSDK_DIR}/examples/morpheusvm
...
go build -o "$MORPHEUSVM_DIR"/build/morpheus-cli "$MORPHEUSVM_DIR"/cmd/morpheus-cli
