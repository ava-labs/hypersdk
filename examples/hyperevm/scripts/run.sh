...
rm -f "${HYPERSDK_DIR}"/avalanchego-"${VERSION}"/plugins/o1f99fVdFpnvKTT9gM3dC11Du2t9cNQhRuuDzdF6urYaPbG4M

# rebuild with latest code
go build \
-o "${HYPERSDK_DIR}"/avalanchego-"${VERSION}"/plugins/o1f99fVdFpnvKTT9gM3dC11Du2t9cNQhRuuDzdF6urYaPbG4M \
./cmd/hyperevm
