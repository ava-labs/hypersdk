...
import (
	...
	"github.com/ava-labs/hypersdk/examples/hyperevm/throughput"
...
// Construct tmpnet network with a single HyperEVM Subnet
var _ = ginkgo.SynchronizedBeforeSuite(func() []byte {
	...
	// Import HyperSDK e2e test coverage and inject HyperEVM name
